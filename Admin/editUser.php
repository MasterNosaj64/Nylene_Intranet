 ...
 * Purpose:
 * Make the form for editing an employee information.
 */
...
$val1=$_GET["w1"];//value of employee id to be edited, getting from editUserDatabase
$_SESSION['field']=$val1;
...
<script language="javascript">
	...
	if ((userRole=='admin')){//admin can edit all
  
	}
	else if ((userRole=='supervisor')&&(userRole == editRole)){//supervisor cannot edit itself or admin
...
<thead>
<tr>
	<td border=0 colspan="2" style="text-align: center;"><b>- Fill all the fields that need to be changed with new values -</b></td>
</tr>
</thead>
<thead>
<tr>
	<td id="column_heading" colspan="2" style="text-align: center;">Primary Information</td>
</tr>
</thead>
</table>
<table class="form-table" border="1" cellpadding="5" cellspacing="0">
<tr>
	<td style="width: 50%"><label for="first_name">First Name </label><br /> 
	<input name="first_name" type="user" maxlength="50"  placeholder="<?php echo $first_name; ?>"/></td>
	<td style="width: 50%"><label for="last_name">Last Name </label><br /> 
	<input name="last_name" type="user" placeholder="<?php echo $last_name; ?>" maxlength="50" /></td>
</tr>
<tr>
	<td style="width: 50%"><label for="title">Title </label><br /> 
	<select id="options" name="title"  style="color:gray">
	<?php 
	...
	<input name="department" type="user" placeholder="<?php echo $department; ?>" maxlength="50" />
	</td>
</tr>
<tr>
	<td><label for="work_phone">Work Phone </label><br /> 
	<input name="work_phone" type="user" placeholder="<?php echo $work_phone; ?>" maxlength="50" />
	</td>
	<td><label for="reports_to">Reports to</label><br /> 
	<select id="options" name="reports_to" style="color:gray">
	<?php
...
<table class="form-table" border="1" cellpadding="5" cellspacing="0">
<tr>
	<td colspan="2" style="width: 100%"><label for="username">Username </label><br /> 
	<input name="username" type="text" placeholder="<?php echo $username; ?>" maxlength="50"  />
	</td>
</tr>
<tr>
	<td colspan="2" style="width: 100%"><label for="STATUS">Status</label><br />
	<input name="STATUS" type="text" placeholder="<?php echo $STATUS; ?>" maxlength="100" /></td>
</tr>
<tr>
	<td colspan="2"><label for="employee_email">Email </label><br />
	<input name="employee_email" type="text"  placeholder="<?php echo $employee_email; ?>" maxlength="100" /></td>
</tr>
<tr>
	<td colspan="2"><label for="password">Password </label><br />
	<input name="password" type="text" maxlength="100" placeholder="******"/></td>
</tr>
</table>
