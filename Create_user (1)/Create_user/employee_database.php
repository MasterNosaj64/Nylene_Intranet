...
**/
  ...
  $db=mysqli_select_db($connect,$DB_DATABASE);
    ...
    $query=mysqli_query($connect,"INSERT INTO employees1(employee_id,first_name,last_name,tilte,department,work_phone,reports_to,date_entered,date_modified,modified_by,username,is_administrator,STATUS,employee_email,password) VALUES ('$employee_id','$first_name', '$last_name', '$title','$department','$work_phone','$reports_to','$date_entered','$date_modified','$modified_by','$username','$is_administrator','$STATUS','$employee_email','$password')");
 if (!$query) {
 ...
 // $query=mysqli_query($connect,"INSERT INTO employees1(First_Name,Last_Name,Email_Address,DOB,MobilePhone,HomePhone,Address1,Address2,City,PostalCode,StartDate,EmployeeNumber,SIN,Department,VacationDays,VacationPercent,PayRate,EmergencyContactName,EmergencyContactPhone) VALUES('$first_name','$last_name','$email','$dob','$mobile_phone','$home_phone','$address1','$address2','$city','$postal_code','$start_date','$employee_number','$sin','$department','$vacation_days','$vacation_percent','$pay_rate','$emergency_contact_name,'$emergency_contact_phone')");
