...
<html>
   <head>
      <title>Edit Credit Business Application</title>
      <link rel="stylesheet" type="text/css" href="../CSS/form.css">
   </head>

    <body>
	<form name="editcreditBusinessApplication"
		action="editCreditBusinessApplicationDatabase.php" method="POST">
		<table class="form-table" border=1 cellspacing="0" cellpadding="1">
			...
			<tr>
				...
				<td colspan="2"><input type="text" name="phone" required
			...
			<tr>
				<td id="fax">Fax</td>
				<td colspan="2"><input type="text" name="fax" required
					value="<?php echo $creditBusinessRow['fax'];?>"></td>
				<td id="order_pending">Order Pending?
        			<?php if ($checked){ ?>
        			<input type="radio" name="order_pending" value="1" checked> <label
					for="1"> Yes </label> <input type="radio" name="order_pending"
					value="0"> <label for="0"> No </label>
        			<?php } else { ?>
        			<input type="radio" name="order_pending" value="Yes"> <label
					for="Yes"> Yes </label> <input type="radio" name="order_pending"
					value="No" checked> <label for="No"> No </label>
        			<?php } ?> </td>

				<td colspan="2" id="order_amount">Order Amount $<input type="text"
					name="order_amount" required
					value="<?php echo $creditBusinessRow['order_amount'];?>"> /lbs.
				</td>
			</tr>
			<tr>
				<td id="business_email">E-mail</td>
				<td colspan="2"><input type="text" name="business_email" required
					value="<?php echo $creditBusinessRow['business_email'];?>"></td>
				<td><label for="credit_date"> Credit Businees Application Date </label></td>
				<td><input type="date" id="credit_date" name="credit_date"
					value="<?php echo $creditBusinessRow['credit_date'];?>" required></td>
			</tr>
			...
			<tr>
				...
				<td colspan="2"><input type="text" name="bank_fax" required
					value="<?php echo $creditBusinessRow['bank_fax'];?>"></td>
			</tr>
			<tr>
				<td id="bank_phone">Phone</td>
				<td colspan="2"><input type="text" name="bank_phone" required
