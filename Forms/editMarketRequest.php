...
<input type="checkbox"  name="press_release" value=1 <?php if($row['press_release'] == 1) {echo "checked";} ?>>
  <label for="press_release">Press Release/E-Blast</label>
           ...
           <td> <input type="checkbox" name="other_type_of_project"  value =1 <?php if($row['other_type_of_project'] == 1) {echo "checked";} ?>>
               <label for="other_type_of_project">Other (Please specify)</label><input type="text"  name="other_type_of_project" rows="1" column="100" value="<?php echo $row['other_type_of_project']?>"></td></table></td>
...
<input type="checkbox"  name="plant_managers" value=1 <?php if($row['plant_managers'] == 1) {echo "checked";} ?>>
  <label for="plant_managers">Plant/MRO Managers</label>
    ...
    <label for="other_audience">Other (Please specify)</label><input type="text" name="other_audience" rows="1" column="100" value="<?php echo $row['other_audience']?>"></td></tr>
        </table></td></tr>
     ...
     <tr> <td id="Info">
        ...
        <li>Common Objections</li>
             ...
             <td colspan="2"><input type="text" name="Info" rows="11" width="1000px" cols="70" value="<?php echo $row['audiance_personal_info']?>"></td>
        ...
        <tr id="purpose"><b>Purpose</b></tr>
			<tr><td colspan="2"><input type="text" name="purpose" rows="6" cols="120" value="<?php echo $row['purpose'];?>"></td>
        </tr> </table>

        
       <table cellpadding="5" cellspacing="1" class="form-table">
           <tr id="key_messages"><b>Key Messages</b></tr>
			<tr><td colspan="2"><input type ="text" name="key_messages" rows="6" cols="120" value="<?php echo $row['key_message'];?>"></td>
        </tr> </table>

          <table cellpadding="5" cellspacing="1" class="form-table">
              <tr id="support"><b>Supporting Information</b></tr>
			<tr><td colspan="2"><input type ="text" name="support" rows="6" cols="120" value="<?php echo $row['supporting_info'];?>"></td>
        </tr> </table>
...
<tr id="needed_photography">
			<tr><td colspan="2"><input type="text" name="needed_photography" rows="2" cols="120" value="<?php echo $row['needed_photography'];?>"></td>
        </tr> </table>
