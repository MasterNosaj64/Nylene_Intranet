...
$type_of_project=$_POST['type_of_project'];
 ...
 $db=mysqli_select_db($conn, $dbname );
    ...
    $query=mysqli_query($conn,"INSERT INTO marketing_request_form(requester_name,market_segment, sales_territory,email,phone,request_date, name_project_or_piece,is_project_new, if_piece_new, target_audiance, audiance_personal_info, purpose, key_message, supporting_info, is_photography_needed, needed_photography, estimated_quantity, means_of_delivery, date_needed, available_budget, cost_center_number ) VALUES ('$Requester_Name','$Market_Segment', '$Sales_Territory','$Email','$Phone','$Date', '$Name_of_Project','$project_content','$update_info','$target','$Info','$purpose','$key_messages','$support','$is_photography_needed','$needed_photography','$estimate','$delivery','$date_needed','$budget','$cost')");
