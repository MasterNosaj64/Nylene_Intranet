...
<form  method="post" action="editMMform_Database.php"   name="editMMform";>
	...
	<td id="Market_Segment">Market Segment</td>
			<td colspan="2"><input type="text" name="Market_Segment" maxlength="250" style="width: 260px" placeholder="<?php echo $row['market_segment'];?>"></td>
</tr> 
                <tr>
	<td id="Sales_Territory">Sales Territory</td>
			<td colspan="2"><input type="text" name="Sales_Territory" maxlength="250" style="width: 260px" placeholder="<?php echo $row['sales_territory'];?>"></td>
                    
        	<td id="Email">Email</td>
			<td colspan="2"><input type="text" name="Email" maxlength="250" style="width: 260px" placeholder="<?php echo $row['email'];?>"></td>
        </tr>
          <tr>
	
        	<td id="Phone">Phone</td>
			<td colspan="2"><input type="text" name="Phone" maxlength="250" style="width: 260px" placeholder="<?php echo $row['phone'];?>"></td>
...
<tr> <td colspan ="2" id="Name_of_Project">Name of Project
			<input type="text" name="Name_of_Project" maxlength="250" style="width: 260px" placeholder="<?php echo $row['name_project_or_piece'];?>"></td>
 </tr>
          <td id="type_of_project"><b>Type of Project or Piece</b><br>if known<br>If multiple communication are needed,choose all that apply.
			<input type="text" name="type_of_project" maxlength="250" style="width: 260" placeholder="<?php echo $row['type_of_project'];?>"></td>
...
<input type="checkbox"  name="press_release" value=1 <?php if($row['press_release'] == 1) {echo "checked";} ?>>
  <label for="press_release">Press Release/E-Blast</label>
           ...
           <td> <input type="checkbox" name="other_type_of_project"  value =1 <?php if($row['other_type_of_project'] == 1) {echo "checked";} ?>>
               <label for="other_type_of_project">Other (Please specify)</label><input type="text"  name="other_type_of_project" rows="1" column="100" placeholder="<?php echo $row['other_type_of_project']?>"></td></table></td>
         ...
         <tr> <td id="project_content"><b>Is this Project:</b></td>
        		...
        		<input type="radio" name="project_content" value="Yes"
        			...
        			<?php } ?>
                          <td colspan="2"><input type="text" name="update_info" maxlength="250" style="width: 260px" placeholder="<?php echo $row['if_piece_new'];?>"></td></tr></table></td>
         </tr></table>
...
<input type="checkbox"  name="plant_managers" value=1 <?php if($row['plant_managers'] == 1) {echo "checked";} ?>>
  <label for="plant_managers">Plant/MRO Managers</label>
    ...
    <label for="other_audience">Other (Please specify)</label><input type="text" name="other_audience" rows="1" column="100" placeholder="<?php echo $row['other_audience']?>"></td></tr>
        </table></td></tr>
     ...
     <tr> <td id="Info">
        ...
        <li>Common Objections</li>
             ...
             <td colspan="2"><input type="text" name="Info" rows="11" width="1000px" cols="70" placeholder="<?php echo $row['audiance_personal_info']?>"></td>
        ...
        <tr id="purpose"><b>Purpose</b></tr>
			<tr><td colspan="2"><input type="text" name="purpose" rows="6" cols="120" placeholder="<?php echo $row['purpose'];?>"></td>
        </tr> </table>

        
       <table cellpadding="5" cellspacing="1" class="form-table">
           <tr id="key_messages"><b>Key Messages</b></tr>
			<tr><td colspan="2"><input type ="text" name="key_messages" rows="6" cols="120" placeholder="<?php echo $row['key_message'];?>"></td>
        </tr> </table>

          <table cellpadding="5" cellspacing="1" class="form-table">
              <tr id="support"><b>Supporting Information</b></tr>
			<tr><td colspan="2"><input type ="text" name="support" rows="6" cols="120" placeholder="<?php echo $row['supporting_info'];?>"></td>
        </tr> </table>
...
<tr id="needed_photography">
 ...
 <td>Anticipated plan for delivering the piece, tradiotional mailing, blogging,<br/> e-mailing, handing out of events, etc.</td></tr>
           ...
           <tr><td ><b>Date Needed:</b></td> <td >
                     <input type="date" name="date_needed" maxlength= "300" style="width:260px" placeholder="<?php echo $row['date_needed'];?>"></td> <td>A minimum of 4-8 weeks may be required for many printed materials requests.<br/> The scope of some requests, especially new projects or items to be mailed, may require more time.</td></tr>  
            
              <tr><td ><b>Available Budget:</b></td>  <td>
                  <input type="text" name="budget" maxlength= "300" style="width:260px" placeholder="<?php echo $row['available_budget'];?>"></td>
 <td>To cover printing, photography or other vendor charges.</td></tr> 
            
            
              <tr><td ><b>Cost Counter #:</b></td> <td >
                  <input type="text" name="cost" maxlength= "300" style="width:260px" placeholder="<?php echo $row['cost_center_number'];?>"></td>
