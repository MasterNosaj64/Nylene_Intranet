...
<table cellspacing="5" class="inventory">
	  <thead>
				...
				<tbody>
					<tr>
						<td align="center">{tl-1:60} lbs.</td>  
						<td align="center">{tl-2:101} lbs.</td>
						<td align="center">{tl-3:62} lbs.</td>
						<td align="center">{tl-4:63} lbs.</td>
						<td align="center">{tl-5:64} lbs.</td>
						<td align="center">{tl-6:99}lbs.</td>
				  </tr>
				</tbody>
	</table>
<div id="notices">
