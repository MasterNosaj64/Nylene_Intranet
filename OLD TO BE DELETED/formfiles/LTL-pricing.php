...
<!-- Output our HTML markup -->
  ...
  <thead>
					...
					<td width="33%" class="date">{Nylene Grade:70}</td>
					<th width="17%" align="left">SHIP TO LOCATION:</th>
					<td width="33%">{Ship to Address for this Contact (Street Address):137.1}</td>
	</tr>
	</thead><thead>
					<tr>
					  <th align="left">DESCRIPTION:</th>
					<td class="date">{Description:75}</td>
...
<table cellspacing="5" class="inventory">
	  <thead>
					<tr>
				      ...
				      40,000 LB. +</th>
						<th width="16%">22,000 - 39,999 LB.
					    BAGS</th>
						<th width="16%">11,000 - 21,999 LB.
					    BAGS</th>
						<th width="16%">6,600 - 10,999 LB.
					    BAGS</th>
						<th width="16%">4,400 - 6,599 LB.
					    BAGS</th>
						<th width="16%">2,200 - 4,399 LB.
					    BAGS</th>
					</tr>
  </thead><thead>
					<tr>
				...
				<tbody>
					<tr>
						<td align="center">{ltl-1:53} lbs.</td>
						<td align="center">{ltl-2:52} lbs.</td>
						<td align="center">{ltl-3:66} lbs.</td>
						<td align="center">{ltl-4:67} lbs.</td>
						<td align="center">{ltl-5:68} lbs.</td>
						<td align="center">{ltl-6:69} lbs.</span></td>  
				  </tr>
				</tbody>
	</table>
<div id="notices">
...
<div id="notices">
  <div class="notice">
   LTL Quantities are {Shipped Quantities:81}{Custom Shipped Quantities:92}.
  </div>
</div>
