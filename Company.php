...
class Company{
    ...
    $query = "INSERT INTO nylene.company (company_name, website, billing_address_street, billing_address_city, billing_address_state, billing_address_postalcode, billing_address_country, shipping_address_street, shipping_address_city, shipping_address_state, shipping_address_postalcode, shipping_address_country, description, type, industry)
	VALUES (:company_name, :website, :billing_address_street, :billing_address_city, :billing_address_state, :billing_address_postalcode, :billing_address_country, :shipping_address_street, :shipping_address_city, :shipping_address_state, :shipping_address_postalcode, :shipping_address_country, :description, :type, :industry, )"; // 16
