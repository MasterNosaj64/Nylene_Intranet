    		...
    		<tr>
    			...
    			<td width="59%" align="left" valign="top">
                    <div>6. No claim of any kind shall be allowed in amount greater than
                        ...
                        <div>
    					7. Additional charges may apply if goods or materials are
...
<table border="0" cellspacing="5" cellpadding="5">
	<tbody>
		<tr>
			...
			<td width="59%" align="left" valign="top"><div>7. Additional charges
					may apply if goods or materials are shipped in a non-standard form
					of transportation. These charges shall be agreed to by Buyer prior
					to such shipment.</div>
				<p>
					<br>
				</p>
				<div>8. Seller shall have the right, in addition to all others it
				...
				<div>
					19. Unless otherwise indicated, all monetary amounts are in United
					States of<br> America currency.
				</div>
				<p>
					<br>
				</p>
