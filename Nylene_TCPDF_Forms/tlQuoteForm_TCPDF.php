...
if (isset($_POST['submit'])) {
    ...
    $content .= <<<EOF
            ...
            <table  border="1">
    			<thead>
    				<tr>
                        <th colspan="2" style="text-align: center; background-color: rgb(168, 216, 255)"><strong>- Employee Information -</strong></th>
    				</tr>
    			</thead>
    			<tr>
    				<td> First Name </td>
    			...
    			<thead>
    				<tr>
                        <th colspan="2" style="text-align: center; background-color: rgb(168, 216, 255)"><strong>- Customer Information -</strong></th>
    				</tr>
    			</thead>
    			<tr>
